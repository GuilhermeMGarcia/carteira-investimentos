...
function onOpen() {
  ...
  ui.createMenu('🚀 Scripts')
    .addItem('📊 Atualizar Indicadores (FIIs)', 'atualizarFIIs')
    .addItem('📅 Atualizar Eventos', 'atualizarCalendarioEventos') // NOVA LINHA
    .addSeparator()
    .addItem('📅 Filtrar Eventos', 'buscarTickerNoCalendario')
    .addSeparator()
