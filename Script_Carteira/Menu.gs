...
function onOpen() {
  ...
  ui.createMenu('🚀 Scripts')
    .addItem('🏦 Atualizar Taxa (Tesouro)', 'atualizarTesouroIPCA')
    .addItem('🏦 Atualizar Macro (Selic/IPCA)', 'atualizarBCB') // NOVA LINHA
    .addSeparator()
    .addItem('📅 Atualizar Feriados', 'atualizarFeriadosNacionais')
    .addSeparator()
...
function mostrarStatusRapido() {
  ...
  const dados = abaStatus.getRange("A2:C6").getValues();
